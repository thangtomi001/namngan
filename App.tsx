...
import { MapPin, ShieldCheck, TrendingUp, Gem, CheckCircle2, ArrowRight, Phone, Clock, Building, AlertTriangle, Newspaper, ExternalLink } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="font-sans text-slate-800 bg-slate-50">
      ...
      {/* Sticky Mobile CTA */}
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 p-3 flex gap-3 z-50 shadow-[0_-10px_20px_rgba(0,0,0,0.1)]">
        <a href="tel:0838456567" className="flex-1 bg-slate-900 text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2">
          <Phone className="h-5 w-5" /> Gọi ngay
        </a>
        <button onClick={scrollToForm} className="flex-1 bg-amber-600 text-white py-3 rounded-xl font-bold flex items-center justify-center">
          Nhận báo giá
        </button>
      </div>
    </div>
